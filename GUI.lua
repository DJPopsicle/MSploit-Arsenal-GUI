...
local Window1 = library:CreateWindow("FPS") -- Creates the window

local Window2 = library:CreateWindow("Trolling") -- Creates the window

local Window3 = library:CreateWindow("Player")

local Aim = Window1:CreateFolder("Aim") -- Creates the folder(U will put here your buttons,etc)

local Visual = Window1:CreateFolder("Visual") -- Creates the folder(U will put here your buttons,etc)

local Misc = Window1:CreateFolder("Misc") -- Creates the folder(U will put here your buttons,etc)

local Universal = Window2:CreateFolder("Universal")

local Player = Window3:CreateFolder("Player Mods")
...
Player:Label("Player Modifications",{
    TextSize = 25; -- Self Explaining
    TextColor = Color3.fromRGB(255,255,255); -- Self Explaining
    BgColor = Color3.fromRGB(69,69,69); -- Self Explaining
...
-- Aim:Button("Button",function()
--     print("Elym Winning")
-- end)

Aim:Button("Silent Aimbot",function(bool)
    -- Remember To Like And Subscribe For More :) -Dev Z Scripts
    loadstring(game:HttpGet(("https://pastebin.com/raw/yL0sHzfP"), true))()
    -- Aimbot 
...
Aim:Button("Aimlock",function(bool)
...
Visual:Button("ESP",function(bool)
    loadstring(game:HttpGet(("https://pastebin.com/raw/a2dwhBU7"), true))()
end)

Visual:Button("Tracers",function(bool)
    -- shared.tracers = bool
    showTracers = true
    print(showTracers)
    if (showTracers == true) then
    ...
    -- elseif (showTracers == false) then
    --     print("the condition is working")
    --     Tracer.Visible = false
    end
end)

Misc:Button("Fly (Press E)",function(bool)
    loadstring(game:HttpGet(("https://pastebin.com/raw/VkUNXT7G"), true))()
end)

Misc:Button("Noclip (Press Q)",function(bool)
    loadstring(game:HttpGet(("https://pastebin.com/raw/ryt1EQAV"), true))()
end)

Universal:Button("Ultimate Trolling GUI",function(bool)
...
-- Aim:Dropdown("Dropdown",{"Aim","Visual","Misc"},true,function(mob) --true/false, replaces the current title "Dropdown" with the option that t
--     print(mob)
-- end)

-- Aim:Bind("Bind",Enum.KeyCode.C,function() --Default bind
--     print("Yes")
-- end)

-- Aim:ColorPicker("ColorPicker",Color3.fromRGB(255,0,0),function(color) --Default color
--     print(color)
-- end)

-- Aim:Box("Box","number",function(value) -- "number" or "string"
--     print(value)
-- end)
